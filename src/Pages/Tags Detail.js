            ...
            <MDBRow className="pt-0 pb-0 xs:px-5 sm:px-1">
              ...
              <MDBRow className="pt-4 px-0">
                <p>
                  ...
                  Mild Cognitive Impairment, Alzhiemer’s and Parkinson’s
                  diseases (PD). In addition, we use computational modeling and
                  machine learning methods to map neural activity to brain
                  functions and to develop brain-based diagnostic tools for
              ...
              <MDBRow className="pt-4 ps-0">
                <p>
                  Mild cognitive impairment (MCI) is a condition characterized
                  by early decline in memory and cognitive skills, experienced
                  in approximately 20% of elderly population aged 60 and above.
                  Research in this topic is geared towards developing tools for
                  early detection of MCI, which can help prevent or
                  significantly slow down the onset of more serious mental
                  degenerative diseases such as Alzheimer’s. We successfully
                  trained artificial neural networks (shown in photo) to
                  recognize important neuromarker for MCI at the accuracy level
                  superior to human scorers. As part of an ongoing research, we
                  partner with MQDC (Magnolia Quality Development Corporation
                  Limited) to develop intervention techniques (exercise, brain
                  stimulation) that can slow down or prevent the onset of MCI
                  symptoms.
                </p>
              </MDBRow>
              ...
              <MDBRow>
                <h5
                  ...
                  style={{ color: "#A02040", fontFamily: "FontMedium" }}
                >
                  2. Web-based applications for monitoring cognitive impairment
                  in aging population
                </h5>
                <MDBCol md="6">
                  {" "}
